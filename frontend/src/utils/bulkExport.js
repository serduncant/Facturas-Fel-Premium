...
export const exportInvoicesToZip = async (invoices, invoiceRefs, onProgress) => {
...
export const exportSelectedToExcel = async (invoices) => {
...
export const exportSelectedToJSON = (invoices) => {
    const timestamp = new Date().toISOString().split('T')[0];
